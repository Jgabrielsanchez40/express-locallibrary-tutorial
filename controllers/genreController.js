...
exports.genre_create_post = [
  ...
  (req, res, next) => {
    ...
    if(!errors.isEmpty()) {
      //There are errors. Render the form again with sanitized values/eror messages.
      ...
      Genre.findOne({ 'name': req.body.name })
        .exec( function(err, found_genre) {
          ...
          if(found_genre) {
            //Genre Exists, redirect ri its detail page.
...
exports.genre_delete_post = function(req, res, next) {
  async.parallel({
    ...
    if(results.genre_books.length > 0) {
      //Author has books. Reden in same way as for Get route.
      res.render('genre_delete', { title:'Delete Genre', genre: results.genre, genre_books: results.genre_books });
      return
    }
    else {
      //Author has not book. Delete object and redirect to the list of author
